...
- (UITableViewCell *)cellForIndexPath:(NSIndexPath *)indexPath {
    return [self.dataSource tokenField:self.tokenField suggestionCellForPartialText:self.tokenField.inputText atIndex:indexPath.row];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    [self.delegate suggestionManagerDidSelectCell:[self cellForIndexPath:indexPath] atIndex:indexPath.row];
...
- (UITableView *)tableView {
    ...
    CGRect newFrame =
        CGRectMake(CGRectGetMinX(globalTokenViewFrame), CGRectGetMaxY(globalTokenViewFrame), CGRectGetWidth(globalTokenViewFrame),
